...
def prepare_db(opt):
    ...
    if opt.dataset == 'gtd100':
        train_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtrain1/train100.csv', target_col='gname')
        eval_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtest1/test100.csv', target_col='gname')
        return {'train': train_dataset, 'eval': eval_dataset}

    elif opt.dataset == 'gtd200':
        train_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtrain1/train200.csv', target_col='gname')
        eval_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtest1/test200.csv', target_col='gname')
        return {'train': train_dataset, 'eval': eval_dataset}

    elif opt.dataset == 'gtd300':
        train_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtrain1/train300.csv', target_col='gname')
        eval_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtest1/test300.csv', target_col='gname')
        return {'train': train_dataset, 'eval': eval_dataset}

    elif opt.dataset == 'gtd478':
        train_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtrain1/train478.csv', target_col='gname')
        eval_dataset = dataset.UCIgtd('../../../data/top30groups/noGeographic/scaledtest1/test478.csv', target_col='gname')
        return {'train': train_dataset, 'eval': eval_dataset}
    else:
