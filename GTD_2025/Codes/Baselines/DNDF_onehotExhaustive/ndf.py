...
class GTDFeatureLayer100(nn.Sequential):
    def __init__(self, hidden_dim=1024, dropout_rate=0., shallow=True):
        ...
        if shallow:
            self.add_module('linear', nn.Linear(1803, hidden_dim)) 
        else:
...
class GTDFeatureLayer200(nn.Sequential):
    def __init__(self, hidden_dim=1024, dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(3173, hidden_dim)) 
        else:
            raise NotImplementedError
...
class GTDFeatureLayer300(nn.Sequential):
    def __init__(self, hidden_dim=1024, dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(4392, hidden_dim)) 
        else:
            raise NotImplementedError
...
class GTDFeatureLayer478(nn.Sequential):
    def __init__(self, hidden_dim=1024, dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(6309, hidden_dim)) 
        else:
            raise NotImplementedError
