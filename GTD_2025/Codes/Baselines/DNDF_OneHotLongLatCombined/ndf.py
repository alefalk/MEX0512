...
class GTDFeatureLayer100(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        if shallow:
            self.add_module('linear', nn.Linear(1803, 1024)) 
        else:
...
class GTDFeatureLayer200(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(6305, 1024)) 
        else:
            raise  NotImplementedError
...
class GTDFeatureLayer300(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(8724, 1024)) 
        else:
            raise  NotImplementedError
...
class GTDFeatureLayer478(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(12511, 1024)) 
        else:
            raise  NotImplementedError
