...
def prepare_db(opt):
    ...
    if opt.dataset == 'gtd100':
        train_data_path = '../../../data/top30groups/anonLoc/scaledtrain1/train100.csv'
        test_data_path = '../../../data/top30groups/anonLoc/scaledtest1/test100.csv'
    elif opt.dataset == 'gtd200':
        train_data_path = '../../../data/top30groups/anonLoc/scaledtrain1/train200.csv'
        test_data_path = '../../../data/top30groups/anonLoc/scaledtest1/test200.csv'
    elif opt.dataset == 'gtd300':
        train_data_path = '../../../data/top30groups/anonLoc/scaledtrain1/train300.csv'
        test_data_path = '../../../data/top30groups/anonLoc/scaledtest1/test300.csv'
    elif opt.dataset == 'gtd478':
        train_data_path = '../../../data/top30groups/anonLoc/scaledtrain1/train478.csv'
        test_data_path = '../../../data/top30groups/anonLoc/scaledtest1/test478.csv'
    else:
